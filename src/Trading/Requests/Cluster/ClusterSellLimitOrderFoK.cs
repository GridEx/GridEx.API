...
namespace GridEx.API.Trading.Requests.Cluster
{
	...
	public readonly struct ClusterSellLimitOrderFoK : IClusterHftLimitOrder
	{
		public ClusterSellLimitOrderFoK(long requestId, long userId, double price, double volume)
		{
			Size = MessageSize;
			TypeCode = HftRequestTypeCode.ClusterSellLimitOrderFoK;
			RequestId = requestId;
			UserId = userId;
			Price = price;
			Volume = volume;
		...
		{
			fixed (ClusterSellLimitOrderFoK* thisAsPointer = &this)
		...
		public static readonly ushort MessageSize = Convert.ToUInt16(Marshal.SizeOf<ClusterSellLimitOrderFoK>());
	}
}