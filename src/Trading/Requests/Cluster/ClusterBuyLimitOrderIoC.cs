...
namespace GridEx.API.Trading.Requests.Cluster
{
	...
	public readonly struct ClusterBuyLimitOrderIoC : IClusterHftLimitOrder
	{
		public ClusterBuyLimitOrderIoC(long requestId, long userId, double price, double volume)
		{
			Size = MessageSize;
			TypeCode = HftRequestTypeCode.ClusterBuyLimitOrderIoC;
			RequestId = requestId;
			UserId = userId;
			Price = price;
			Volume = volume;
		...
		{
			fixed (ClusterBuyLimitOrderIoC* thisAsPointer = &this)
		...
		public static readonly ushort MessageSize = Convert.ToUInt16(Marshal.SizeOf<ClusterBuyLimitOrderIoC>());
	}
}