...
namespace GridEx.API.Trading.Requests.Cluster
{
	...
	public readonly struct ClusterBuyLimitOrder : IClusterHftLimitOrder
	{
		public ClusterBuyLimitOrder(long requestId, long userId, double price, double volume)
		{
			Size = MessageSize;
			TypeCode = HftRequestTypeCode.ClusterBuyLimitOrder;
			RequestId = requestId;
			UserId = userId;
			Price = price;
			Volume = volume;
		...
		public static readonly ushort MessageSize = Convert.ToUInt16(Marshal.SizeOf<ClusterBuyLimitOrder>());
	}
}