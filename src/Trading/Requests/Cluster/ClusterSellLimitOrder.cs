...
namespace GridEx.API.Trading.Requests.Cluster
{
	...
	public readonly struct ClusterSellLimitOrder : IClusterHftLimitOrder
	{
		public ClusterSellLimitOrder(long requestId, long userId, double price, double volume)
		{
			Size = MessageSize;
			TypeCode = HftRequestTypeCode.ClusterSellLimitOrder;
			RequestId = requestId;
			UserId = userId;
			Price = price;
			Volume = volume;
		...
		{
			fixed (ClusterSellLimitOrder* thisAsPointer = &this)
		...
		public static readonly ushort MessageSize = Convert.ToUInt16(Marshal.SizeOf<ClusterSellLimitOrder>());
	}
}